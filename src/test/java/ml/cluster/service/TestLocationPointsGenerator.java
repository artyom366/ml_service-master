...
public class TestLocationPointsGenerator {
    ...
    public static List<Point> generateLocationPoints(final int quantity, final int maxX, final int maxY) {
        final List<PointImpl> points = new ArrayList<>();
        ...
        IntStream.range(0, quantity).forEach(item -> {
            ...
            final PointImpl point = PointImpl.newInstance(location);
            points.add(point);
        });
    ...
    public static PointImpl generateSingleLocationPoint(final double x, final double y) {
        final PickLocationViewDO location = new PickLocationViewDO();
        location.setX(x);
        location.setY(y);
    ...
    private static List<Point> generateSpecificLocationPoints() {
        ...
        final PointImpl point_0_0 = generateSingleLocationPoint(0, 0);
        point_0_0.setCell(new ImmutablePair<>(0L, 0L));

        final PointImpl point_0_1 = generateSingleLocationPoint(1, 1);
        point_0_1.setCell(new ImmutablePair<>(0L, 0L));

        final PointImpl point_0_2 = generateSingleLocationPoint(1, 2);
        point_0_2.setCell(new ImmutablePair<>(0L, 0L));

        final PointImpl point_0_3 = generateSingleLocationPoint(2, 3);
        point_0_3.setCell(new ImmutablePair<>(0L, 0L));
        //break of the cluster 1

        //outlier
        final PointImpl point_0 = generateSingleLocationPoint(9, 3);
        point_0.setCell(new ImmutablePair<>(1L, 0L));

        //start of the cluster 2
        final PointImpl point_1_0 = generateSingleLocationPoint(8, 8);
        point_1_0.setCell(new ImmutablePair<>(1L, 1L));

        final PointImpl point_1_2 = generateSingleLocationPoint(7, 8);
        point_1_2.setCell(new ImmutablePair<>(1L, 1L));

        final PointImpl point_1_3 = generateSingleLocationPoint(9, 9);
        point_1_3.setCell(new ImmutablePair<>(1L, 1L));

        //outlier
        final PointImpl point_1 = generateSingleLocationPoint(1, 9);
        point_1.setCell(new ImmutablePair<>(0L, 1L));

        final PointImpl point_1_4 = generateSingleLocationPoint(9, 8);
        point_1_4.setCell(new ImmutablePair<>(1L, 1L));

        final PointImpl point_1_5 = generateSingleLocationPoint(7, 9);
        point_1_5.setCell(new ImmutablePair<>(1L, 1L));

        final PointImpl point_1_6 = generateSingleLocationPoint(8, 9);
        point_1_6.setCell(new ImmutablePair<>(1L, 1L));
        //end of the cluster 2

        //continuation of the cluster 1
        final PointImpl point_0_4 = generateSingleLocationPoint(2, 2);
        point_0_4.setCell(new ImmutablePair<>(0L, 0L));

        final PointImpl point_0_5 = generateSingleLocationPoint(3, 2);
        point_0_5.setCell(new ImmutablePair<>(0L, 0L));

        final PointImpl point_0_6 = generateSingleLocationPoint(2, 1);
        point_0_6.setCell(new ImmutablePair<>(0L, 0L));

        final PointImpl point_0_7 = generateSingleLocationPoint(2, 7);
        point_0_7.setCell(new ImmutablePair<>(0L, 1L));
        //end of the cluster 1

        //outlier
        final PointImpl point_2 = generateSingleLocationPoint(0, 9);
        point_1.setCell(new ImmutablePair<>(0L, 1L));
